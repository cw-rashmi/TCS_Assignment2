...
contract Student{
    ...
    //On addition of new student the StudentID is automatically set.
    ...
    function update(uint id,string memory _Student_Name,string memory _Address,string memory _city)public{
        ...
        require(getStudentById[id].exists);
                //the deails of the student with the ID given as the input is oerwritten with the new details.
